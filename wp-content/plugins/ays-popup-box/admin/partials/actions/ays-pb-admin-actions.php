...
//Close button text
$close_button_text = (isset($options['close_button_text']) && $options['close_button_text'] != '') ? $options['close_button_text'] : '✕';
...
$close_button_text_mobile = (isset($options['close_button_text_mobile']) && $options['close_button_text_mobile'] != '') ? $options['close_button_text_mobile'] : '✕';
...
$close_button_position_mobile = (isset($options['close_button_position_mobile']) && $options['close_button_position_mobile'] != '') ? $options['close_button_position_mobile'] : 'right-top';
...
$pb_position_mobile = (isset($options['pb_position_mobile']) && $options['pb_position_mobile'] != 'center-center') ? $options['pb_position_mobile'] : 'center-center';
...
$ays_pb_autoclose_mobile = (isset($options['pb_autoclose_mobile']) && $options['pb_autoclose_mobile'] != "") ? $options['pb_autoclose_mobile'] : $autoclose;
                    ...
                    <div class="col-sm-9">
                        <div class="ays_pb_pc_and_mobile_container ays_pb_pc_and_mobile_container_cb">
                            ...
                            <div class="ays_pb_option_for_mobile_device ays_pb_option_for_mobile_device_cb ays_divider_left <?php echo ($close_popup_overlay_mobile || $close_popup_overlay != 'off') ? 'show' : '' ?>">
                                ...
                                <p class="onoffswitch" style="margin:0;">
                                    <input type="checkbox" name="close_popup_overlay_mobile" class="ays-pb-onoffswitch-checkbox" id="ays_close_popup_overlay" <?php if($close_popup_overlay_mobile){ echo 'checked';} ?>/>
                                </p>
                            </div>
                        </div>
                        <div class="ays-pb-youtube-video-link">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-9 ays_pb_pc_and_mobile_container">
                        <div>
                            ...
                            <div class="ays_pb_mobile_settings_container">
                                <input type="checkbox" class="ays_pb_different_settings_for_mobile" id="ays_pb_enable_autoclose_delay_text_mobile" name="ays_pb_enable_autoclose_delay_text_mobile" <?php echo $enable_autoclose_delay_text_mobile ? 'checked' : '' ?>>
