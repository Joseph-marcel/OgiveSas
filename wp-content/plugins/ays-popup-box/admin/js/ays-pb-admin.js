(function( $ ) {
    ...
    $(document).ready(function (){
        ...
        $(document).on("click", "#ays-pb-dismiss-buttons-content .ays-button", function(e){
            e.preventDefault();
        ...
        $(document).find('table#ays-pb-position-table tr td, table#ays_pb_bg_image_position_table tr td, table#ays-pb-position-table-mobile tr td').on('click', function(e){
            ...
            if (flag == 'popup_position' || flag == 'bg_image_position') {
                ...
                $(this).parents('.pb_position_block').find('.ays-pb-position-val-class-mobile').val(val);
            }
        ...
        $(document).on('click', '.ays-pb-reset-styles', function(){
            ...
            $(this).parents('form#ays_pb_form').find('div.ays-pb-title-shadow div.ays_toggle_target').css('display', 'none');
            ...
            $(this).parents('form#ays_pb_form').find('select#ays-pb-animate_out').parent('div.ays_pb_aysDropdown').find('div.text').text(defaultValues.closeAnimText);

            $(this).parents('form#ays_pb_form').find('select#ays-pb-animate_in').val(defaultValues.openAnim);
            $(this).parents('form#ays_pb_form').find('select#ays-pb-animate_in').parent('div.ays_pb_aysDropdown').find('div.text').text(defaultValues.openAnimText);
            ...
            $(document).find('table#ays_pb_bg_image_position_table td').removeAttr('style');
            $(document).find('table#ays_pb_bg_image_position_table tr td[data-id=5]').css('background-color','#3d89e0');

            $(this).parents('form#ays_pb_form').find('select#ays_pb_bg_image_sizing').val(defaultValues.bgImgSizing);
            $(this).parents('form#ays_pb_form').find('select#ays_pb_bg_image_sizing').parent('div.ays_pb_aysDropdown').find('div.text').text(defaultValues.bgImgSizingText);

            $(this).parents('form#ays_pb_form').find('input#ays-enable-background-gradient').prop('checked', defaultValues.bgGrad);
            $(this).parents('form#ays_pb_form').find('div.ayspb-enable-background-gradient div.ays_toggle_target').css('display', 'none');
            ...
            $(this).parents('form#ays_pb_form').find('select#ays_pb_gradient_direction').parent('div.ays_pb_aysDropdown').find('div.text').text(defaultValues.bgGradDirText);
            ...
            $(this).parents('form#ays_pb_form').find('div.ays_pb_close_btn_bg_img_container').css('display', 'none');
            ...
            $(this).parents('form#ays_pb_form').find('div.ays-pb-box-shadow div.ays_toggle_target').css('display', 'none');
            ...
            $(this).parents('form#ays_pb_form').find('div.ays_bg_image_box label.ays-pb-modal-close img.close_btn_img').css('display', 'none');
            $(this).parents('form#ays_pb_form').find('div.ays_bg_image_box label.ays-pb-modal-close img.close_btn_text').css('display', 'block');
            $(this).parents('form#ays_pb_form').find('div.ays-pb-live-container').css( {'font-family': defaultValues.fontFamily});

            $(this).parents('form#ays_pb_form').find('div.ays_pb_aysDropdown div.menu div.item').removeClass('active selected');
            $(this).parents('form#ays_pb_form').find('div.ays_pb_aysDropdown div.menu').each(function() {
                $(this).find('div.item:first-child').addClass('active selected');
            });
        });
