...
class Ays_PopupBox_List_Table extends WP_List_Table {
    ...
    public function duplicate_popupbox( $id ){
        ...
        if (current_user_can('unfiltered_html')) {
            $popup_custom_html = sanitize_text_field($popup['custom_html']);
        } else {
            $popup_custom_html = wp_kses_post($popup['custom_html']);
        }
    ...
    public function add_or_edit_popupbox($data){
        ...
        //Close button text
        $close_button_text = (isset($data['ays_pb_close_button_text']) && $data['ays_pb_close_button_text'] != '') ? $data['ays_pb_close_button_text'] : '✕';
        ...
        $close_button_text_mobile = (isset($data['ays_pb_close_button_text_mobile']) && $data['ays_pb_close_button_text_mobile'] != '') ? $data['ays_pb_close_button_text_mobile'] : '✕';
        ...
        $close_button_position_mobile = ( isset($data['ays_pb_close_button_position_mobile']) && $data['ays_pb_close_button_position_mobile'] != '' ) ? $data['ays_pb_close_button_position_mobile'] : 'right-top';
        ...
        $close_popup_overlay_mobile = (isset($data['close_popup_overlay_mobile']) && $data['close_popup_overlay_mobile'] == 'on') ? $data['close_popup_overlay_mobile'] : 'off';
