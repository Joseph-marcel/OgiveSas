...
class Ays_Pb_Public_Templates {
	...
	public function ays_pb_template_default( $attr ){
        ...
        $message_data = array(
            'popup_title'            => $popup['ays_pb_title'],
        ...
        if($popup['ays_pb_title'] != ''  && $popup['show_title'] == "On"){
            $popup['ays_pb_title'] = "<h2 style='color:" . $popup['ays_pb_textcolor'] . " !important;font-family:$ays_pb_font_family;{$title_text_shadow}; font-size: 24px; margin: 0;font-weight: normal;'>" . $popup['ays_pb_title'] . "</h2>";
        } else {$popup['ays_pb_title'] = "";}
        ...
        if($popup['ays_pb_description'] != '' && $popup['show_desc'] == "On"){
            $content_desktop = Ays_Pb_Public::ays_autoembed( $popup['ays_pb_description'] );
            $popup['ays_pb_description'] = "<div class='ays_pb_description' style='font-size:{$pb_font_size}px'>".$content_desktop."</div>";
        }else{
           $popup['ays_pb_description'] = ""; 
        }
        if($popup['ays_pb_action_buttons_type'] == 'both' || $popup['ays_pb_action_buttons_type'] == 'pageLoaded'){
           if(intval($popup['ays_pb_delay']) == 0 && intval($popup['ays_pb_scroll_top']) == 0){
                $ays_pb_animate_in_open = $popup['ays_pb_animate_in'];
            }else{
        ...
        $pb_autoclose_mobile = ( isset($options->pb_autoclose_mobile) && $options->pb_autoclose_mobile != '' && $enable_autoclose_delay_text_mobile ) ? intval(esc_attr($options->pb_autoclose_mobile)) : $popup['ays_pb_autoclose'];

        if(isset($options->enable_open_delay_mobile) && $options->enable_open_delay_mobile == 'on'){
            if($pb_autoclose_mobile > 0){
                $popup_mobile_delay_in_seconds = ($options->open_delay_mobile > 0) ? intval($options->open_delay_mobile) / 1000 : 0;
                if ($options->open_delay_mobile != 0 && ($pb_autoclose_mobile < $popup_mobile_delay_in_seconds || $pb_autoclose_mobile >= $popup_mobile_delay_in_seconds) ) {
        ...
        if($enable_hide_timer == 'on'){
            $ays_pb_timer_desc = "<p class='ays_pb_timer ays_pb_timer_".$popup['id']."' style='visibility:hidden'>".__("This will close in ", "ays-popup-box")." <span data-seconds='" . $popup['ays_pb_autoclose'] . "' data-ays-seconds='{$attr["autoclose"]}' data-ays-mobile-seconds='{$pb_autoclose_mobile}'>" . $popup['ays_pb_autoclose'] . "</span>".__(" seconds", "ays-popup-box")."</p>";
        }else{
            $ays_pb_timer_desc = "<p class='ays_pb_timer ays_pb_timer_".$popup['id']."'>".__("This will close in ", "ays-popup-box")." <span data-seconds='" . $popup['ays_pb_autoclose'] . "' data-ays-seconds='{$attr["autoclose"]}' data-ays-mobile-seconds='{$pb_autoclose_mobile}'>" . $popup['ays_pb_autoclose'] . "</span>".__(" seconds", "ays-popup-box")."</p>";
        }
        ...
        $popupbox_view = "
                <div class='ays-pb-modal ays-pb-modal_".$popup['id']." ".$popup['custom_class']." ".$ays_pb_animate_in_open." ".$ays_pb_disable_scroll_on_popup_class." ".$ays_pb_show_scrollbar_class." ays-popup-box-main-box' {$ays_pb_flag} style='".$popup['ays_pb_bg_image'].";width: {$pb_width}; height: {$pb_height}; background-color:" .  $popup['ays_pb_bgcolor'] . "; color: " . $popup['ays_pb_textcolor'] . " !important; border: ".$popup['ays_pb_bordersize']."px  $border_style " .$popup['ays_pb_bordercolor']. "; border-radius: ".$popup['ays_pb_border_radius']."px;font-family:{$ays_pb_font_family};{$box_shadow};' >
                    $ays_pb_sound_mute
                    " . $popup['ays_pb_title'] . "
                    " . $popup['ays_pb_description'] . "
    ...
    public function ays_pb_template_macos($attr){
        ...
        if($popup['ays_pb_title'] != ''   && $popup['show_title'] == "On"){
            $popup['ays_pb_title'] = "<h2 style='color: ".$popup['ays_pb_textcolor']." !important;font-family:$ays_pb_font_family;{$title_text_shadow}'>".$popup['ays_pb_title']."</h2>";
        } else {$popup['ays_pb_title'] = "";}
        ...
        if($popup['ays_pb_action_buttons_type'] == 'both' || $popup['ays_pb_action_buttons_type'] == 'pageLoaded'){
           if($popup['ays_pb_delay'] == 0 && $popup['ays_pb_scroll_top'] == 0){
                $ays_pb_animate_in_open = $popup['ays_pb_animate_in'];
            }else{
                $ays_pb_animate_in_open = "";
            } 
        ...
        $enable_autoclose_delay_text_mobile = isset($options->enable_autoclose_delay_text_mobile) && $options->enable_autoclose_delay_text_mobile == 'on' ? true : false;
        $pb_autoclose_mobile = ( isset($options->pb_autoclose_mobile) && $options->pb_autoclose_mobile != '' && $enable_autoclose_delay_text_mobile ) ? esc_attr($options->pb_autoclose_mobile) : $popup['ays_pb_autoclose'];
        ...
        $mac_view = "<div class='ays_window ays-pb-modal_".$popup['id']." ".$popup['custom_class']." ".$ays_pb_animate_in_open." ".$ays_pb_disable_scroll_on_popup_class." ".$ays_pb_show_scrollbar_class."' {$ays_pb_flag} style='width: {$pb_width}; height: {$pb_height}; ".$popup['ays_pb_bg_image']."; background-color: ".$popup['ays_pb_bgcolor']."; color: ".$popup['ays_pb_textcolor']." !important; border: ".$popup['ays_pb_bordersize']."px $border_style ".$popup['ays_pb_bordercolor']."; border-radius: ".$popup['ays_pb_border_radius']."px;font-family:{$ays_pb_font_family};{$box_shadow}'>
    ...
    public function ays_pb_template_cmd($attr){      
        ...
        $cmd_view = "<div class='ays_cmd_window ays-pb-modal_".$popup['id']." ".$popup['custom_class']." ".$ays_pb_animate_in_open." ".$ays_pb_disable_scroll_on_popup_class." ".$ays_pb_show_scrollbar_class."' {$ays_pb_flag} style='width: {$pb_width}; height: {$pb_height}; background-color: ".$popup['ays_pb_bgcolor']."; ".$popup['ays_pb_bg_image'].";  color: ".$popup['ays_pb_textcolor']." !important; border: ".$popup['ays_pb_bordersize']."px $border_style ".$popup['ays_pb_bordercolor']."; border-radius: ".$popup['ays_pb_border_radius']."px;font-family:{$ays_pb_font_family};{$box_shadow} !important;'>
    ...
    public function ays_pb_template_ubuntu($attr){     
        ...
        $ubuntu_view = "<div class='ays_ubuntu_window ays-pb-modal_".$popup['id']." ".$popup['custom_class']." ".$ays_pb_animate_in_open." ".$ays_pb_disable_scroll_on_popup_class." ".$ays_pb_show_scrollbar_class."' {$ays_pb_flag} style='width: {$pb_width}; height: {$pb_height}; ".$popup['ays_pb_bg_image'].";  background-color: ".$popup['ays_pb_bgcolor']."; color: ".$popup['ays_pb_textcolor']." !important; border: ".$popup['ays_pb_bordersize']."px $border_style ".$popup['ays_pb_bordercolor']."; border-radius: ".$popup['ays_pb_border_radius']."px;font-family:{$ays_pb_font_family};{$box_shadow}'>
    ...
    public function ays_pb_template_winxp($attr){
        ...
        if($popup['ays_pb_title'] != '' && $popup['show_title'] == "On"){
            $popup['ays_pb_title'] = "<h2 style='color: white !important;font-family:$ays_pb_font_family;{$title_text_shadow}'>".$popup['ays_pb_title']."</h2>";
        } else {$popup['ays_pb_title'] = "";}
        ...
        $ubuntu_view = "<div class='ays_winxp_window ays-pb-modal_".$popup['id']." ".$popup['custom_class']." ".$ays_pb_animate_in_open." ".$ays_pb_disable_scroll_on_popup_class." ".$ays_pb_show_scrollbar_class."' {$ays_pb_flag} style='width: {$pb_width}; height: {$pb_height}; color: ".$popup['ays_pb_textcolor']." !important; border: ".$popup['ays_pb_bordersize']."px $border_style ".$popup['ays_pb_bordercolor']."; border-radius: ".$popup['ays_pb_border_radius']."px;font-family:{$ays_pb_font_family};{$box_shadow};'>
                            ...
                            <div class='ays_winxp_content' style='background-color: ".$popup['ays_pb_bgcolor']."; ".$popup['ays_pb_bg_image']."; '>
                                $ays_pb_sound_mute
                                <div>
                                    ".$popup['ays_pb_description']."
    ...
    public function ays_pb_template_win98($attr){
        ...
        if($popup['ays_pb_title'] != '' && $popup['show_title'] == "On"){
            $popup['ays_pb_title'] = "<h2 style='color: white !important;{$title_text_shadow}'>".$popup['ays_pb_title']."</h2>";
        } else {$popup['ays_pb_title'] = "";}
        ...
        $ubuntu_view = "<div class='ays_win98_window ays-pb-modal_".$popup['id']." ".$popup['custom_class']." ".$ays_pb_animate_in_open." ".$ays_pb_disable_scroll_on_popup_class." ".$ays_pb_show_scrollbar_class."' {$ays_pb_flag} style='width: {$pb_width}; height: {$pb_height}; padding: {$pb_padding}; background-color: ".$popup['ays_pb_bgcolor']."; ".$popup['ays_pb_bg_image'].";  color: ".$popup['ays_pb_textcolor']." !important; border: ".$popup['ays_pb_bordersize']."px $border_style ".$popup['ays_pb_bordercolor']."; border-radius: ".$popup['ays_pb_border_radius']."px;font-family:{$ays_pb_font_family};{$box_shadow};'>
    ...
    public function ays_pb_template_lil($attr){
        ...
        $ubuntu_view = "    <div class='ays_lil_window ays-pb-modal_".$popup['id']." ".$popup['custom_class']." ".$ays_pb_animate_in_open." ".$ays_pb_disable_scroll_on_popup_class." ".$ays_pb_show_scrollbar_class."' {$ays_pb_flag} style='width: {$pb_width}; height: {$pb_height}; background-color: ".$popup['ays_pb_bgcolor']."; color: ".$popup['ays_pb_textcolor']." !important; border: ".$popup['ays_pb_bordersize']."px $border_style ".$popup['ays_pb_bordercolor']."; border-radius: ".$popup['ays_pb_border_radius']."px;font-family:{$ays_pb_font_family};".$popup['ays_pb_bg_image'].";{$box_shadow};'>
    ...
    public function ays_pb_template_template($attr){
        ...
        $ubuntu_view = "   <div class='ays_template_window ".$ays_pb_disable_scroll_on_popup_class." ays-pb-modal_".$popup['id']." ".$popup['custom_class']." ".$ays_pb_animate_in_open." ".$ays_pb_show_scrollbar_class."' {$ays_pb_flag} style='width: {$pb_width};  height: {$pb_height}; color: ".$popup['ays_pb_textcolor']." !important; font-family:{$ays_pb_font_family}; border: ".$popup['ays_pb_bordersize']."px $border_style ".$popup['ays_pb_bordercolor'].";{$bg_gradient_container}; border-radius: ".$popup['ays_pb_border_radius']."px; {$box_shadow};'>
                                ...
                                <footer class='ays_template_footer ' style='background-color: ".$popup['ays_pb_bgcolor']."; {$calck_template_fotter} '>
    ...
    public function ays_pb_template_minimal($attr){
        ...
        $ubuntu_view .= "   <div class='ays_minimal_window ays-pb-modal_".$popup['id']." ".$popup['custom_class']." ".$ays_pb_animate_in_open."' {$ays_pb_flag} style='width: {$pb_width}; height: {$pb_height}; background-color: ".$popup['ays_pb_bgcolor']."; color: ".$popup['ays_pb_textcolor']." !important;font-family:{$ays_pb_font_family}; border: ".$popup['ays_pb_bordersize']."px $border_style ".$popup['ays_pb_bordercolor']."; border-radius: ".$popup['ays_pb_border_radius']."px; ".$popup['ays_pb_bg_image'].";{$box_shadow};' data-name='modern_minimal'>
    ...
    public function ays_pb_template_video($attr){
        ...
        $ubuntu_view .= "   <div class='ays_video_window ays-pb-modal_".$popup['id']." ".$popup['custom_class']." ".$ays_pb_animate_in_open."' {$ays_pb_flag} style='width: {$pb_width}; height: {$pb_height}; background-color: ".$popup['ays_pb_bgcolor']."; color: ".$popup['ays_pb_textcolor']." !important;font-family:{$ays_pb_font_family}; border: ".$popup['ays_pb_bordersize']."px $border_style ".$popup['ays_pb_bordercolor']."; border-radius: ".$popup['ays_pb_border_radius']."px; {$box_shadow}; ' data-name='modern_video'>
    ...
    public function ays_pb_set_popup_options($popup_options) {
        ...
        $options = array(
            ...
            'ays_pb_width'                   => $popup_options["width"],
            'ays_pb_height'                  => $popup_options["height"],
            'ays_pb_autoclose'               => $popup_options["autoclose"],
            ...
            'ays_pb_header_bgcolor'		    => $popup_options["header_bgcolor"],
            'ays_pb_animate_in'              => $popup_options["animate_in"],
            'show_desc'                      => $popup_options["show_popup_desc"],
            'show_title'                     => $popup_options["show_popup_title"],
            'closeButton'                    => $popup_options["close_button"],
            'ays_pb_custom_html'             => $popup_options["custom_html"],
            'ays_pb_action_buttons_type'     => $popup_options["action_button_type"],
            'ays_pb_modal_content'           => $popup_options["modal_content"],
            ...
            'ays_pb_bordersize'              => (!isset($popup_options["bordersize"])) ? 0 : $popup_options["bordersize"],
            'ays_pb_bordercolor'             => (!isset($popup_options["bordercolor"])) ? "#000000" : stripslashes(esc_attr( $popup_options["bordercolor"] )),
            'ays_pb_border_radius'           => (!isset($popup_options["border_radius"])) ? "4" : $popup_options["border_radius"],
            'custom_class'                   => (isset($popup_options["custom_class"]) && $popup_options["custom_class"] != "") ? $popup_options["custom_class"] : "",
            'ays_pb_bg_image'                => (isset($popup_options["bg_image"]) && $popup_options['bg_image'] != "" ) ? $popup_options["bg_image"] : "",
