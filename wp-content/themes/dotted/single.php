                        ...
                        <div class="item-blog">
                            ...
                            <div class="blog-feature-content single-feature-blog">
                                ...
                                <div class="blog-footer-2 border-color-theme">
                                    <ul class="left-info">
                                        <li class="meta-a blog-list-style-2"><?php echo esc_html__('Posté par ', 'dotted'); ?><?php the_author_posts_link(); ?></li>
                                        <li class="meta-c blog-list-style-2"><?php echo esc_html__('Categorie ', 'dotted'); ?> <?php the_category( ', ' ); ?></li>
                                    </ul>
                                </div>
                            </div>
                        </div>
