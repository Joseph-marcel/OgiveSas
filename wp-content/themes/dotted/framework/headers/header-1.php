    ...
    <div class="topbar-1 bg-theme">
        <div class="topbar-1-inner">
            ...
            <div class="topbar-info topbar-info-1">
                <ul>
                  <li>
                    <i class="fa fa-clock-o color-theme"><span class="service-p"></i>Lundi-Vendredi / 8h-17h</span>
                  </li>
                  <li>
                    <i class="fa fa-phone color-theme"></i></i><span class="service-p">(+237) 694 674 286 / 694467 982</span>
                  </li>
                  <li>
                    <i class="fa fa-envelope-o color-theme"></i><span class="service-p">siogivesas@gmail.com</span>
                  </li>
                </ul>
            </div>
            <?php } ?>
